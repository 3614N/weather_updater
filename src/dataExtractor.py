...
def extract_stations(a : str):
    if a == "all":
        ...
        print(f"https://bulk.meteostat.net/v2/hourly/{a}.csv.gz")
        webbrowser.open(f"https://bulk.meteostat.net/v2/hourly/{a}.csv.gz", new=0, autoraise=True)
